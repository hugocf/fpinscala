package fpinscala.ch10monoids

import fpinscala.ch07parallelism.Nonblocking._
import fpinscala.ch07parallelism.Nonblocking.Par.toParOps // infix syntax for `Par.map`, `Par.flatMap`, etc
...
object Monoid {
  ...
  import fpinscala.ch08testing._
  import Prop._
